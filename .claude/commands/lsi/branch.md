...
**Canonical source:** [`overlays/lsi/docs/workflows/openspec-git-integration.md` § Branch checklist](../../overlays/lsi/docs/workflows/openspec-git-integration.md#branch-checklist) · [branch-workflow.md](../../docs/workflows/branch-workflow.md) · [git-trello.md](../../overlays/lsi/docs/sdlc/git-trello.md)
...
3. **Missing or wrong branch**
   ...
   - If card already exists and you need a **new** branch for that card, suggest **`/lsi:trello-list`** then **`/lsi:trello-branch <card-id>`** (or `git tb <card_id>`) per [git-trello.md](../../overlays/lsi/docs/sdlc/git-trello.md).
