...
**Canonical source:** [ticket-card-info.md](../../docs/workflows/ticket-card-info.md) · [git-trello.md](../../overlays/lsi/docs/sdlc/git-trello.md) · [`overlays/lsi/docs/workflows/openspec-git-integration.md`](../../overlays/lsi/docs/workflows/openspec-git-integration.md)
...
5. **Create or link Trello card**
   ...
   **Path A — create card (default):**
   ...
   Source credentials: `source ~/.trello_secrets` ([git-trello.md](../../overlays/lsi/docs/sdlc/git-trello.md)).
   ...
   **Path B — link existing card (user supplied id):**
   ...
   If API or credentials fail, stop and point to [git-trello.md](../../overlays/lsi/docs/sdlc/git-trello.md).
