...
**Canonical source:** [commit-pr-conventions.mdc](../../.cursor/rules/commit-pr-conventions.mdc) · [`overlays/lsi/docs/workflows/openspec-git-integration.md` § Merge extended description](../../overlays/lsi/docs/workflows/openspec-git-integration.md#merge-extended-description-bitbucket)
