...
**Canonical source:** [pull-requests.md](../../docs/workflows/pull-requests.md) · [pr-description.template.md](../../templates/pr-description.template.md) · [`overlays/lsi/docs/workflows/openspec-git-integration.md` § Pull request](../../overlays/lsi/docs/workflows/openspec-git-integration.md#pull-request-from-openspec)
