...
**Canonical source:** [git-trello.md](../../overlays/lsi/docs/sdlc/git-trello.md) · [ticket-card-info.md](../../docs/workflows/ticket-card-info.md) · [`overlays/lsi/docs/workflows/openspec-git-integration.md`](../../overlays/lsi/docs/workflows/openspec-git-integration.md)
