...
**Canonical source:** [git-trello.md](../../overlays/lsi/docs/sdlc/git-trello.md) · [ticket-card-info.md](../../docs/workflows/ticket-card-info.md) · [`lsi-trello-branch.md`](lsi-trello-branch.md)
...
1. **Verify git-trello install**
   ...
   - If missing alias, stop — [git-trello.md](../../overlays/lsi/docs/sdlc/git-trello.md).
