...
Enforced by [snippets/cursor-rules/commit-pr-conventions.mdc](snippets/cursor-rules/commit-pr-conventions.mdc) (installed locally to `.cursor/rules/` via `./snippets/bootstrap-maintainer-local.sh`).
