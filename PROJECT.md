# Project placeholders — cursor-dev-workflows

Resolved values for **this repository**. Application repos adopting the bundle should maintain their own `PROJECT.md` with project-specific values.

| Token | Value (this repo) |
|-------|-------------------|
| `REPO_NAME` | `cursor-dev-workflows` |
| `CANONICAL_DOCS_PATH` | `docs/workflows/` |
| `BUNDLE_VERSION` | `1.0.1` (matches [VERSION](VERSION); adopters use tag or SHA) |
| `BASE_BRANCH` | `main` |
| `PR_HOST` | `GitHub` |
