# adopt-bundle-version-token

## Purpose

Ensure the LSI adopt pipeline injects bundle version tokens into overlay copies and that maintainer dogfood metadata stays in sync with `VERSION`.
