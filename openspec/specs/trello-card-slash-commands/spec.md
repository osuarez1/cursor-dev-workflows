# trello-card-slash-commands

## Purpose

Define Trello card slash commands for existing branches and To Do cards, with OpenSpec-gated redacted card copy and adopter parity expectations.
