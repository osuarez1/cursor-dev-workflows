...
**Canonical source:** [commits-logical-order.md](../../docs/workflows/commits-logical-order.md) · [`docs/workflows/openspec-git-integration.md` § Commit mapping](../../docs/workflows/openspec-git-integration.md#commit-mapping)
