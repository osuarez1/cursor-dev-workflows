...
**Canonical source:** [`docs/workflows/openspec-git-integration.md`](../../docs/workflows/openspec-git-integration.md) · [which-workflow.md](../../docs/workflows/which-workflow.md)
...
3. **Workflow overview** — summarize lifecycle from [openspec-git-integration.md](../../docs/workflows/openspec-git-integration.md):
...
5. **Pointer to docs**
   ...
   - [openspec-git-integration.md](../../docs/workflows/openspec-git-integration.md) — full lifecycle.
