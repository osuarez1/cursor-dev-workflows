...
When drafting a card description for a milestone or OpenSpec phase, follow [ticket-card-info.md](../ticket-card-info.md) (three fenced blocks: task type, title, description). Source scope from `openspec/changes/*/tasks.md`, `docs/roadmap/milestones-v1.md`, and `docs/contracts/` when relevant.
