...
**Canonical source:** [`.lsi/workflows/openspec-git-integration.md` § Branch checklist](../../.lsi/workflows/openspec-git-integration.md#branch-checklist) · [branch-workflow.md](../../.lsi/workflows/branch-workflow.md) · [git-trello.md](../../.lsi/workflows/sdlc/git-trello.md)
...
3. **Missing or wrong branch**
   ...
   - If card already exists, suggest `git tb <card_id>` per [git-trello.md](../../.lsi/workflows/sdlc/git-trello.md).
