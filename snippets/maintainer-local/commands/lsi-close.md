...
**Canonical source:** [`.lsi/workflows/openspec-git-integration.md` § Production close](../../.lsi/workflows/openspec-git-integration.md#production-close-after-main-merge)
