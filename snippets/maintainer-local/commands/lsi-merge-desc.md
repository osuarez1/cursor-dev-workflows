...
**Canonical source:** [commit-pr-conventions.mdc](../../.cursor/rules/commit-pr-conventions.mdc) · [`.lsi/workflows/openspec-git-integration.md` § Merge extended description](../../.lsi/workflows/openspec-git-integration.md#merge-extended-description-bitbucket)
