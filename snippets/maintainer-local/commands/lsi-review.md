...
**Canonical source:** [code-review.md](../../.lsi/workflows/code-review.md) · [`.lsi/workflows/openspec-git-integration.md` § Code review](../../.lsi/workflows/openspec-git-integration.md#code-review)
